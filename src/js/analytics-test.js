  ...
  try {
    ...
    function initTestButton() {
      try {
        ...
        console.error('Error initializing analytics test button:', e);
      }
    }
    ...
    function checkAnalyticsStatus() {
      try {
        ...
        console.error('Error checking analytics status:', e);
        alert('Error checking analytics status. See console for details.');
      }
    }
  } catch (e) {
    console.error('Error in analytics test script:', e);
  }
})(); 